...
function SunMark() {
  return (
    <>
      <circle cx="16" cy="16" r="7" style={{ fill: "var(--decoration-sun)" }} />
      <g style={{ stroke: "var(--decoration-sun)" }} strokeWidth="2.4" strokeLinecap="round">
...
function MoonMark() {
  return <path d="M23.5 19.2A9.5 9.5 0 1 1 12.8 4a7.5 7.5 0 0 0 10.7 15.2Z" style={{ fill: "var(--decoration-moon)" }} />;
}
