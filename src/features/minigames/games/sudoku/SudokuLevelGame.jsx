...
function readRecords() { if (typeof window === "undefined") return createEmptyRecords(); try { return normalizeRecords(JSON.parse(window.localStorage.getItem(SUDOKU_RECORDS_KEY))); } catch { return createEmptyRecords(); } }
