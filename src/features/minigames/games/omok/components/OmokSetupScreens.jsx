...
function SettingChips({ label, onChange, options, selectedValue }) {
  return (
    <div className="omok-game__settings" role="group" aria-label={label}>
      {options.map(({ label: optionLabel, value }) => (
        <button
          className={`omok-game__setting-chip${selectedValue === value ? " is-selected" : ""}`}
          type="button"
          key={value}
  ...
  return (
    <div className="omok-game__lobby" aria-label="오목 메뉴">
      ...
      <div className="omok-game__menu-grid">
        ...
        <button className="omok-game__menu-option" type="button" onClick={onOpenFriendRoomSetup} disabled={onlineBusy}>
        ...
        <button className="omok-game__menu-option" type="button" onClick={onOpenComputerSetup}>
        ...
        <button className="omok-game__menu-option" type="button" onClick={onOpenSettings}>
